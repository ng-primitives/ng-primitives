...
<iframe
  ...
  src="http://localhost:4200/accordion/accordion"
/>
...
<div ngpAccordion ngpAccordionType="single" ngpAccordionCollapsible>
  <div ngpAccordionItem ngpAccordionItemValue="item-1">
    <button ngpAccordionTrigger>What is your refund policy?</button>
  ...
  <div ngpAccordionItem ngpAccordionItemValue="item-2">
    <button ngpAccordionTrigger>Do you offer technical support?</button>
    <div ngpAccordionContent>No.</div>
  </div>
</div>
```
...
bootstrapApplication(AppComponent, {
  providers: [provideNgpAccordionConfig({})],
});
```
