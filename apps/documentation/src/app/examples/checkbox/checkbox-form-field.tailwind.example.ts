...
@Component({
  ...
  template: `
    <div class="flex items-start gap-x-3" ngpFormField>
      ...
      <label
        class="flex cursor-pointer flex-col gap-y-0.5 text-sm/[1.4] font-[510] tracking-[-0.014em] text-gray-900 dark:text-gray-100"
        ngpLabel
      >
        <p>Enable notifications</p>
        <p
          class="text-[0.8125rem]/[1.5]! font-normal tracking-[-0.011em] text-gray-600 dark:text-gray-300"
          ngpDescription
        >
