    ...
    >
      ...
      >
        @if (filteredOptions().length > 0) {
          ...
          <div
            class="flex items-center justify-center p-4 text-center text-sm font-[510] text-zinc-600 dark:text-zinc-300"
          >
            No options found
          </div>
        }
        ...
        <div
          class="rounded-b-xl border-t border-black/10 bg-zinc-300 px-3 py-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-700 dark:text-zinc-300"
        >
