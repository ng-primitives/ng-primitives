...
@Component({
  ...
  template: `
    <div
      class="relative box-border flex h-[2.125rem] w-[300px] items-center justify-between rounded-lg bg-white shadow-[0_1px_2px_rgba(0,0,0,0.05),0_0_0_1px_rgba(0,0,0,0.1)] transition-colors focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-blue-500 dark:bg-zinc-950 dark:shadow-[0_1px_2px_rgba(255,255,255,0.007),0_0_0_1px_rgba(255,255,255,0.1)] dark:focus-within:outline-blue-400"
    ...
    >
      ...
      >
        ...
        @if (canCreate()) {
          <div
            class="box-border flex h-[2.125rem] w-full cursor-pointer items-center gap-2 rounded-lg px-3 text-sm tracking-[-0.006em] text-zinc-500 transition-colors hover:bg-zinc-100 data-active:bg-zinc-100 data-press:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-white/10 dark:data-active:bg-white/10 dark:data-press:bg-white/20"
            [ngpComboboxOptionValue]="query()"
            ngpComboboxOption
          >
            <ng-icon class="text-base text-zinc-400! dark:text-zinc-500!" name="heroPlus" />
