...
@Component({
  ...
  template: `
    ...
    <ng-template #toast let-dismiss="dismiss">
      <div ngpToast animate.enter="toast-enter" animate.leave="toast-leave">
        ...
        <p class="toast-description">Hover the toast to pause the countdown.</p>
  ...
  styles: `
    ...
    .toast-progress::before {
      ...
      animation: toast-progress var(--ngp-toast-duration) linear forwards;
    }

    [ngpToast][data-paused] .toast-progress::before {
...
export default class ToastProgressExample {
  private readonly toastManager = inject(NgpToastManager);

  show(toast: TemplateRef<void>): void {
    this.toastManager.show(toast, { placement: 'bottom-end', duration: 5000 });
  }
}
