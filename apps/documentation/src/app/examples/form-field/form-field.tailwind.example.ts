...
@Component({
  ...
  template: `
    <div class="flex w-[90%] flex-col gap-1.5" [formGroup]="formGroup" ngpFormField>
      ...
      <input
        class="h-9 w-full min-w-0 rounded-lg border-none px-4 shadow-sm outline-none placeholder:text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-blue-500 dark:bg-zinc-900 dark:text-gray-100 dark:placeholder:text-gray-500"
        ngpFormControl
        type="text"
