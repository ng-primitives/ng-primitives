...
@Component({
  ...
  template: `
    <div class="flex w-[300px] flex-col gap-1.5" [formGroup]="formGroup" ngpFormField>
      ...
      <input
        class="h-[2.125rem] w-full min-w-0 rounded-lg border-none bg-white px-4 text-sm tracking-[-0.006em] text-gray-900 shadow-xs ring-1 ring-black/10 outline-hidden placeholder:text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-blue-500 dark:bg-zinc-950 dark:text-gray-100 dark:ring-white/10 dark:placeholder:text-gray-500 dark:focus:outline-blue-400"
        ngpFormControl
        type="text"
