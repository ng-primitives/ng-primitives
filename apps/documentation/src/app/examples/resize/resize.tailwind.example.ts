...
@Component({
  ...
  template: `
    <div
      class="flex h-28 max-h-[200px] min-w-28 resize items-center justify-center overflow-hidden rounded-sm border border-dashed border-black p-4 dark:border-white"
