...
Overlays all portal into `document.body`, so give the menu and the dialog overlay the same `z-index` and the one opened last paints on top, whichever way round they are nested.
