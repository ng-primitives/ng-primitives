...
export class NgpTabset {
  ...
  /**
   * Access the tab buttons within the tabset
   * @internal
   */
  ...
  /**
   * @internal
   * Register a button with the tabset
   */
  registerTab(button: NgpTabButton): void {
    this.buttons.update(buttons => [...buttons, button]);
  }

  /**
   * @internal
   * Unregister a button with the tabset
   */
  unregisterTab(button: NgpTabButton): void {
    this.buttons.update(buttons => buttons.filter(btn => btn !== button));
  }
}
