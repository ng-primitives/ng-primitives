 ...
 * Floating UI has positioned it (data-placement is set via afterRenderEffect
 * once computePosition resolves and finalPlacement is updated).
 */
...
describe('Menu outlet element positioning', () => {
  ...
  it('should position the inner [ngpMenu] element for wrapped component menus', async () => {
    ...
    // Verify the wrapper element itself is NOT being positioned
