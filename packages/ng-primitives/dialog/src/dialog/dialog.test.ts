...
describe('NgpDialog', () => {
  ...
  it('should close dialog when pointerdown and click both occur on the overlay', async () => {
    const { ref } = openDialog();
    const closedSpy = vi.fn();
    ref.closed.subscribe(closedSpy);
  ...
  it('should close dialog on Escape key via registry', async () => {
    const { ref } = openDialog();
    const closedSpy = vi.fn();
    ref.closed.subscribe(closedSpy);
  ...
  describe('Overlay Integration', () => {
    it('should keep dialog open after menu closes when opened from menu item click', async () => {
    ...
    it('should keep dialog-from-dialog parent relationship', async () => {
    ...
    it('should keep dialog open after popover closes when opened from popover content', async () => {
