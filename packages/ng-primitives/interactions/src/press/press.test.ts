...
import { NgpPress, provideInteractionsConfig } from 'ng-primitives/interactions';
import { describe, expect, it, vi } from 'vitest';

describe('NgpPress', () => {
  it('should initialise correctly', async () => {
    await render(`<div ngpPress></div>`, { imports: [NgpPress] });
  });
  ...
  it('should emit press events on mouse interaction', async () => {
    ...
    const container = await render(
      ...
      { imports: [NgpPress], componentProperties: { pressStart, pressEnd, pressChange } },
    );
  ...
  it('should not emit press events when disabled', async () => {
    ...
    fireEvent.pointerDown(container.getByTestId('trigger'));
  ...
  it('should end press on document pointerup when pointerdown started on the element', async () => {
    ...
    const container = await render(
      ...
      { imports: [NgpPress], componentProperties: { pressEnd, pressChange } },
    );
  ...
  describe('keyboard interactions', () => {
    ...
    it('should ignore repeated key events', async () => {
      ...
      const container = await render(
        ...
        { imports: [NgpPress], componentProperties: { pressStart } },
      );
    ...
    it('should not emit press events when disabled', async () => {
      ...
      const container = await render(
        ...
        { imports: [NgpPress], componentProperties: { pressStart, pressChange } },
      );
    ...
    it('should ignore keyboard press events on contenteditable elements', async () => {
      ...
      const trigger = container.getByTestId('trigger');
      Object.defineProperty(trigger, 'isContentEditable', { value: true, configurable: true });
      fireEvent.keyDown(trigger, { key: 'Enter' });
      fireEvent.keyDown(trigger, { key: ' ' });
