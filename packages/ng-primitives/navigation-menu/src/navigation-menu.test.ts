...
describe('Navigation Menu', () => {
  ...
  describe('Content Panel', () => {
    it('should have role="menu" on content', async () => {
      ...
      await waitFor(() =>
        expect(document.querySelector('[data-testid="content-products"]')).toBeInTheDocument(),
      );
    ...
    it('should have data-open attribute on content', async () => {
      ...
      await waitFor(() => {
        expect(document.querySelector('[data-testid="content-products"]')).toBeInTheDocument();
        expect(document.querySelector('[data-testid="content-products"]')).toHaveAttribute(
          'data-open',
        );
      });
    });
  ...
  describe('Content Item', () => {
    it('should have role="menuitem" on content items', async () => {
      ...
      await waitFor(() =>
        expect(document.querySelector('[data-testid="content-item-1"]')).toBeInTheDocument(),
      );
  ...
  describe('Focus Management', () => {
    it('should close on Escape from content and restore focus to trigger', async () => {
      ...
      // Wait for content to appear and data-open to be set on trigger
      await waitFor(() => {
        expect(document.querySelector('[data-testid="content-products"]')).toBeInTheDocument();
        expect(trigger).toHaveAttribute('data-open');
      });
...
describe('Navigation Menu Content Orientation', () => {
  ...
  it('should set content orientation', async () => {
    ...
    await waitFor(() => {
      ...
      expect(document.querySelector('[data-testid="content"]')).toHaveAttribute(
        'data-orientation',
        'vertical',
      );
    });
...
describe('Navigation Menu Cooldown Behavior', () => {
  ...
  it('should set data-instant attribute when switching within cooldown period', async () => {
    ...
    await waitFor(() =>
      expect(document.querySelector('[data-testid="content-1"]')).toBeInTheDocument(),
    );
